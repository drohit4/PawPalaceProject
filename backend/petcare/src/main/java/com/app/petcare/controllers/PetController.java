...
public class PetController {
	...
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "SUCCESSFULLY_RETRIEVED_ALL_PETS", content = @Content(mediaType = "application/json", schema = @Schema(implementation = PetDTO.class), examples = @ExampleObject(value = "[{ \"petId\": 1, \"petName\": \"Buddy\", \"breed\": \"Dog\", \"age\": 5, \"medicalHistory\": \"No issues\", \"createdAt\": \"2025-01-01T10:00:00\", \"updatedAt\": \"2025-01-01T10:00:00\" }]"))),
	...
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "SUCCESSFULLY_RETRIEVED_PET_BY_ID", content = @Content(mediaType = "application/json", schema = @Schema(implementation = PetDTO.class), examples = @ExampleObject(value = "{ \"petId\": 1, \"petName\": \"Buddy\", \"breed\": \"Dog\", \"age\": 5, \"medicalHistory\": \"No issues\", \"createdAt\": \"2025-01-01T10:00:00\", \"updatedAt\": \"2025-01-01T10:00:00\" }"))),
	...
	@ApiResponses(value = {
			@ApiResponse(responseCode = "201", description = "SUCCESSFULLY_SAVED_PET_DATA", content = @Content(mediaType = "application/json", schema = @Schema(implementation = PetDTO.class), examples = @ExampleObject(value = "{ \"petId\": 1, \"petName\": \"Buddy\", \"breed\": \"Dog\", \"age\": 5, \"medicalHistory\": \"No issues\", \"createdAt\": \"2025-01-01T10:00:00\", \"updatedAt\": \"2025-01-01T10:00:00\" }"))),
	...
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "SUCCESSFULLY_UPDATED_PET_DATA", content = @Content(mediaType = "application/json", schema = @Schema(implementation = PetDTO.class), examples = @ExampleObject(value = "{ \"petId\": 1, \"petName\": \"Buddy\", \"breed\": \"Dog\", \"age\": 6, \"medicalHistory\": \"No issues\", \"createdAt\": \"2025-01-01T10:00:00\", \"updatedAt\": \"2025-01-02T12:00:00\" }"))),
	...
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "SUCCESSFULLY_DELETED_PET_DATA", content = @Content(mediaType = "application/json", schema = @Schema(implementation = DeleteResponse.class), examples = @ExampleObject(value = "{ \"message\": \"PET_DATA_DELETED_SUCCESSFULLY\", \"status\": \"success\" }"))),
			@ApiResponse(responseCode = "404", description = "PET_NOT_FOUND_WITH_ID", content = @Content) })
	@DeleteMapping("/{petId}")
