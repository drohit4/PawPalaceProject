...
public class UserController {
	...
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "SUCCESSFULLY_RETRIEVED_ALL_USERS", content = @Content(mediaType = "application/json", schema = @Schema(implementation = UserDTO.class), examples = @ExampleObject(value = "[{ \"userId\": 1, \"username\": \"john_doe\", \"password\": \"password123\", \"email\": \"john.doe@example.com\", \"mobNumber\": \"1234567890\" }]"))),
	...
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "SUCCESSFULLY_RETRIEVED_USER_BY_ID", content = @Content(mediaType = "application/json", schema = @Schema(implementation = UserDTO.class), examples = @ExampleObject(value = "{ \"userId\": 1, \"username\": \"john_doe\", \"password\": \"password123\", \"email\": \"john.doe@example.com\", \"mobNumber\": \"1234567890\" }"))),
	...
	@ApiResponses(value = {
			@ApiResponse(responseCode = "201", description = "SUCCESSFULLY_SAVED_USER_DATA", content = @Content(mediaType = "application/json", schema = @Schema(implementation = UserDTO.class), examples = @ExampleObject(value = "{ \"userId\": 1, \"username\": \"john_doe\", \"password\": \"password123\", \"email\": \"john.doe@example.com\", \"mobNumber\": \"1234567890\" }"))),
	...
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "SUCCESSFULLY_UPDATED_USER_DATA", content = @Content(mediaType = "application/json", schema = @Schema(implementation = UserDTO.class), examples = @ExampleObject(value = "{ \"userId\": 1, \"username\": \"john_doe\", \"password\": \"newpassword123\", \"email\": \"john.doe@example.com\", \"mobNumber\": \"9876543210\" }"))),
	...
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "SUCCESSFULLY_DELETED_USER_DATA", content = @Content(mediaType = "application/json", schema = @Schema(implementation = DeleteResponse.class), examples = @ExampleObject(value = "{ \"message\": \"USER_DATA_DELETED_SUCCESSFULLY\", \"status\": \"success\" }"))),
			@ApiResponse(responseCode = "404", description = "USER_NOT_FOUND_WITH_ID", content = @Content) })
